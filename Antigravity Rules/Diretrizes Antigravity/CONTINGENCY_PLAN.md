...
6. Regra de Validação de Deploy: "Você nunca deve dar uma tarefa de publicação como concluída baseando-se apenas no comando git push. Você é obrigado a acessar a URL pública do deploy via browser tool e confirmar visualmente a presença das alterações antes de reportar ao CEO."
