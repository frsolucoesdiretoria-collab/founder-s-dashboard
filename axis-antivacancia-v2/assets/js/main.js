...
const CONFIG = {
  ...
  webhookUrl: window.location.origin + '/api/axis-v2/lead',
  
  // URL para notificação de novo lead (Telegram/WhatsApp)
  notifyUrl: window.location.origin + '/api/axis-v2/notify',
  ...
  // Checkouts Mercado Pago (manter os mesmos da V1 ou atualizar se necessário)
  checkouts: {
    avista: 'https://mpago.la/2mox6KZ',
    entrada: 'https://mpago.la/29M9mhq',
    completo: 'https://mpago.la/164FDaK'
  }
};
