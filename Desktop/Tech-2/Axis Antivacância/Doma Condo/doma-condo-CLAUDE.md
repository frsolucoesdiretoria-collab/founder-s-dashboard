...
|---|---|---|
| Brand Guide | `brand-guide.md` | Fonte da verdade para identidade visual: tipografia, cores, paleta, ícones |

> Sempre consulte o `brand-guide.md` antes de tomar qualquer decisão visual ou de design.
