                ...
                <div className="section axis-section-padding" style={{ padding: '50px 0' }}>
                    <div className="row">
                        <div className="col s12 center animate-element">
                            ...
                            <div className="grey-text" style={{ fontFamily: "'Futura Md BT', sans-serif", fontSize: '1.4rem', lineHeight: '1.6rem', marginTop: '1.68rem', marginBottom: '3.68rem' }}>PROBLEMA DETECTADO: A TAXA SILENCIOSA</div>
                        ...
                        <div className="col s12 center" style={{ marginTop: '50px' }}>
                            ...
                            <div style={{ marginTop: '40px' }}>
                                <p style={{ fontFamily: "'Futura Md BT', sans-serif", fontSize: '1.2rem', color: 'rgba(255,255,255,0.7)' }}>Pare de aceitar a ineficiência como "parte do negócio".</p>
