...
const CONFIG = {
  ...
  // ⚠️ CONFIGURAR COM URL REAL  
  notifyUrl: 'https://SEU_WEBHOOK_AQUI.com/notify',
...
/**
 * Dispara evento para Google Analytics 4 via dataLayer (GTM)
 */
...
/**
 * Dispara conversão para Google Ads via dataLayer (GTM)
 */
