...
export default function AxisV533Page() {
...
<br>
<span class="grey-text text-darken-1" style="font-family: 'Futura Md BT', sans-serif;">ESCANEAMENTO</span>
</div>
</div>
</div>
...
<br>
<span class="grey-text text-darken-1" style="font-family: 'Futura Md BT', sans-serif;">IDENTIFICAÇÃO</span>
</div>
</div>
</div>
</div>
...
<br>
<span class="grey-text text-darken-1" style="font-family: 'Futura Md BT', sans-serif;">EXECUÇÃO</span>
</div>
</div>
</div>
<div style="width: 14%; margin: 0 3%;" class="vertical-container">
        ...
        <div class="row">
            <div class="col s12 m6">
                <div class="card-panel grey darken-4" style="border: 1px solid rgba(255,255,255,0.1);">
                    <div id="avatar-dr-roberto" style="width: 60px; height: 60px; background-color: #333; border-radius: 50%; margin-bottom: 20px; display: flex; align-items: center; justify-content: center;">
                        <i class="material-icons-round grey-text text-darken-1">person</i>
                    </div>
            ...
            <div class="col s12 m6">
                <div class="card-panel grey darken-4" style="border: 1px solid rgba(255,255,255,0.1);">
                     <div id="avatar-dra-juliana" style="width: 60px; height: 60px; background-color: #333; border-radius: 50%; margin: 0 auto 20px auto; display: flex; align-items: center; justify-content: center;">
                        <i class="material-icons-round grey-text text-darken-1">person</i>
                    </div>
