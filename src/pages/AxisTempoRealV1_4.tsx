// AXIS TEMPO REAL V1.4 — Scroll Storytelling Experience
// Copy locked: Renders content/axis-tempo-real.v1.md faithfully + scroll UX
...
const AxisTempoRealV1_4: React.FC = () => {
  ...
  return (
    <div className="relative w-full min-h-screen bg-white">
      ...
      {/* Problem Section with Sticky Illustration */}
      ...
      {/* Fire with Stone Examples with TimeLeakBars */}
      ...
      {/* How it Works with Sticky Illustration */}
      ...
      {/* Future Warning with Sticky Illustration */}
...
export default AxisTempoRealV1_4;
