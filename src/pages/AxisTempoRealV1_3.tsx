// AXIS TEMPO REAL V1.3 — With Premium SVG Illustrations
// Copy locked: Renders content/axis-tempo-real.v1.md faithfully + illustrations
...
const AxisTempoRealV1_3: React.FC = () => {
  ...
  return (
    <div className="relative w-full min-h-screen bg-white overflow-hidden">
      ...
      {/* Hero Section with StoneToFire illustration */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <motion.h1
                ...
                className="text-4xl md:text-6xl lg:text-7xl font-medium text-slate-900 tracking-tight leading-[1.05]"
              >
              ...
              <motion.p
                ...
                className="text-xl md:text-2xl text-slate-600 leading-relaxed font-light tracking-tight"
              >
            ...
            <div className="flex items-center justify-center">
              <StoneToFire className="w-full max-w-md" />
            </div>
          </div>
        </Section>
      </motion.div>

      {/* Problem Section with LanternScan */}
      <Section size="lg" maxWidth="xl">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1">
            <LanternScan className="w-full max-w-md mx-auto" />
          </div>
      ...
      {/* Fire with Stone Section with TimeLeakBars */}
      <Section size="lg" maxWidth="xl">
      ...
      {/* How it Works with WhatsAppAudioFlow */}
      <Section size="lg" maxWidth="xl">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <Prose>
          ...
          <div className="flex items-center justify-center">
            <WhatsAppAudioFlow className="w-full max-w-md" />
          </div>
        </div>
      </Section>
      ...
      {/* Future Warning with NavalTsunami */}
      <Section size="lg" maxWidth="xl" variant="dark">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1 flex items-center justify-center">
            <NavalTsunami className="w-full max-w-md" />
          </div>
...
export default AxisTempoRealV1_3;
