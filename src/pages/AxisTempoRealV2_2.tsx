...
// Chapter component with elegant numbering
const Chapter: React.FC<{ number: string; title: React.ReactNode; children: React.ReactNode; variant?: 'light' | 'dark' }> = ({ 
  number, 
  title, 
  children,
  variant = 'light' 
...
// Pull Quote component with glow effect
  ...
  return (
    ...
    >
      ...
      `}>
        {/* Glow effect */}
        {variant === 'accent' && (
          <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 via-purple-500/10 to-pink-500/10 opacity-50 blur-3xl" />
        )}
...
const AxisTempoRealV2_2: React.FC = () => {
  ...
  return (
    <div className="relative w-full bg-white min-h-screen overflow-hidden">
      ...
      <Chapter number="02" title="O passado sempre parece ridículo — depois que a tecnologia chega" variant="light">
        <div className="space-y-8 text-xl md:text-2xl text-slate-700 leading-relaxed">
      ...
      <Chapter number="03" title={<>A "macaquice" moderna tem outro nome: custo fixo</>} variant="light">
        <div className="space-y-8 text-xl md:text-2xl text-slate-700 leading-relaxed">
      ...
      {/* Chapter 05: Tsunami */}
      <Chapter number="05" title="A tsunami já começou. E ela não pede licença." variant="light">
        <div className="space-y-8 text-xl md:text-2xl text-slate-700 leading-relaxed">
          <p>
          ...
          <div className="grid md:grid-cols-3 gap-6 my-12">
            <Card className="p-8 bg-slate-50 border-0 text-center">
              <p className="text-2xl font-medium text-slate-900">Quem investe cedo<br />vira barco.</p>
            </Card>
            <Card className="p-8 bg-slate-900 border-0 text-center">
      ...
      <Chapter number="07" title={<>Como funciona <span className="text-slate-500 font-normal">(simples o suficiente pra virar hábito)</span></>} variant="dark">
        <div className="space-y-8 text-xl md:text-2xl text-slate-300 leading-relaxed">
      ...
      <Chapter number="08" title={<>O que isso muda no seu lucro <span className="text-slate-500 font-normal">(de verdade)</span></>} variant="light">
        ...
        <div className="space-y-12 mt-16">
          <Card className="p-12 bg-slate-50 border-0">
            <div className="flex items-start gap-8">
              <span className="text-7xl font-light text-slate-200">7</span>
              <div>
                <h3 className="text-3xl font-medium text-slate-900 mb-4">Em 7 dias</h3>
                <p className="text-xl text-slate-700 leading-relaxed">
                  Você já enxerga os maiores vazamentos.
                </p>
              </div>
            </div>
          </Card>

          <Card className="p-12 bg-slate-900 border-0">
            <div className="flex items-start gap-8">
              <span className="text-7xl font-light text-white/20">15</span>
              <div>
                <h3 className="text-3xl font-medium text-white mb-4">Em 15 dias</h3>
                <p className="text-xl text-slate-300 leading-relaxed mb-6">
                  Você tem clareza suficiente para realocar pessoas:
                </p>
                <EditorialList 
                  variant="dark"
                  items={[
          ...
          <Card className="p-12 bg-slate-50 border-0">
            <div className="flex items-start gap-8">
              <span className="text-7xl font-light text-slate-200">30</span>
              <div>
                <h3 className="text-3xl font-medium text-slate-900 mb-4">Em 30 dias</h3>
                <p className="text-xl text-slate-700 leading-relaxed mb-6">
                  Você recebe o retrato real do seu CNPJ:
                </p>
                <EditorialList 
                  items={[
      ...
      <Chapter number="10" title="Agora, uma última pergunta..." variant="light">
        <div className="space-y-8 text-xl md:text-2xl text-slate-700 leading-relaxed">
      ...
      <footer className="relative py-12 px-6 bg-black border-t border-white/10">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-sm text-slate-500">
            © 2026 AXIS Tempo Real · Editorial V2.2 · Copy hash: <code className="text-xs">{CONTENT_HASH.slice(0, 16)}...</code>
          </p>
        </div>
      </footer>
    </div>
...
export default AxisTempoRealV2_2;
