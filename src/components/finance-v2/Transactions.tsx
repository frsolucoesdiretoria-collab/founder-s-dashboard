...
export function Transactions() {
  ...
  const availableAccountPlans = ACCOUNT_PLANS.filter(ap => 
    ap.entity.includes(newTransaction.entity!) && 
    (newTransaction.type === 'Entrada' ? ap.type === 'Receita' : ap.type === 'Despesa')
  );

  const availableCostCenters = COST_CENTERS.filter(cc => 
    cc.entity.includes(newTransaction.entity!)
  );

  const availableBankAccounts = BANK_ACCOUNTS.filter(ba => 
