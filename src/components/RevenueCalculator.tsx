...
export const RevenueCalculator = () => {
    ...
    return (
        <div className="w-full max-w-5xl mx-auto p-8 bg-surface border border-white/10 rounded-2xl shadow-2xl backdrop-blur-sm relative overflow-hidden">
            ...
            <div className="w-full max-w-4xl mx-auto">
                {!showResult ? (
                    <motion.div
                        ...
                        className="bg-zinc-900/50 backdrop-blur-sm border border-white/10 p-8 rounded-2xl shadow-2xl"
                    >
                        ...
                        <div className="grid md:grid-cols-3 gap-8 mb-12">
                            <div className="space-y-2">
                                <label className="text-sm uppercase tracking-widest text-gray-500 font-bold">Seu Ticket Médio (R$)</label>
                                <input
                                    type="number"
                                    value={ticket}
                                    onChange={(e) => setTicket(e.target.value)}
                                    className="w-full bg-black/50 border-b border-gray-700 focus:border-luxury-gold outline-none py-3 text-2xl text-white font-serif transition-colors"
                                    placeholder="600"
                                />
                            </div>
                            <div className="space-y-2">
                                <label className="text-sm uppercase tracking-widest text-gray-500 font-bold">Atendimentos / Dia</label>
                                <input
                                    type="number"
                                    value={cancellations}
                            ...
                            <div className="space-y-2">
                                <label className="text-sm uppercase tracking-widest text-gray-500 font-bold">Dias Trabalhados</label>
                                <input
                                    type="number"
                        ...
                        <button
                            ...
                            className="w-full bg-luxury-gold hover:bg-white text-black font-bold text-xl py-6 rounded-lg transition-all uppercase tracking-widest shadow-[0_0_30px_rgba(212,175,55,0.2)]"
                        >
                    ...
                    >
                        ...
                        <h3 className="text-gray-400 text-lg uppercase tracking-widest mb-6">RESULTADO:</h3>

                        <div className="mb-8">
                            <p className="text-gray-500 mb-2">Você está deixando</p>
                            <div className="text-6xl md:text-7xl font-bold font-serif text-white drop-shadow-xl">
                                <CountUp
                                    end={annualLoss}
                                    prefix="R$ "
                                    separator="."
